...
data/naive_m1.npz is the released Lorenz 63 naive model at m = 1.  It stores the
MLP weights as a plain npz, so l63.py supplies the Tsit5 step and the network
...
initial conditions, it gives panels (a), (b), (c) of Figure 1:
    ...
    python3 paper_fig1.py          # figure/paper_fig1.png
"""
...
p.add_argument('--out', default='figure/paper_fig1.png')
args = p.parse_args()
